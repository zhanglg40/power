...
<%-- <script src="${ctxStatic}/common/hplus.js?v=4.1.0" type="text/javascript"></script> --%>
<script src="${ctxStatic}/common/jquery.metisMenu.js" type="text/javascript"></script>
<script src="${ctxStatic}/common/jquery.slimscroll.min.js" type="text/javascript"></script>
