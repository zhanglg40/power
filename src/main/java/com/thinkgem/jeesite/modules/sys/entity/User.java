...
public class User extends DataEntity<User> {
	...
	private List<DeviceEntity> devices=Lists.newArrayList();
	private List<String> deviceList ;
	private List<String> otherList ;
	private List<DeviceEntity2> others=Lists.newArrayList();
	public User() {
		super();
	...
	@JsonIgnore
	public List<DeviceEntity2> getOthers() {
		return others;
	}

	public void setOthers(List<DeviceEntity2> others) {
		this.others = others;
	}
