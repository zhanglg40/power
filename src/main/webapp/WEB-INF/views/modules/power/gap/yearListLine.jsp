...
<link rel="stylesheet" href="http://www.jq22.com/jquery/bootstrap-3.3.4.css">
    ...
    function page() {
        ...
        $("#searchForm").attr("action", "${ctx}/power/gap/yearList/Line?type="+type);
        $("#searchForm").submit();
        return false;
    }
        $(function () {
    ...
    function getDataList(chart,sbbId,dateFrom,dayto,sbbType,title) {
        $.ajax({
            ...
            url : '${api}/gap/yearList',

            success : function(data){
                var placelist=[];

                for(var i=0;i<data.data.length;i++){
                    placelist.push([data.data[i].month,parseFloat(data.data[i].value)])
                }
                chart.addSeries({
                    name:title,
                    data:placelist
...
<%-- <ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/power/gap/yearList/Line">设备年统计-曲线图</a></li>
   
        <li><a href="${ctx}/power/gap/yearList/Bar">设备年统计-柱状图</a></li>
    ...
    <tr>
       ...
       <td class="btns">&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td style="width:180px;text-align: right"><label>日期：&nbsp;&nbsp;</label></td><td><input id="dayFrom" name="dayFrom" type="text" readonly="readonly" maxlength="20" style="height:30px;width:110px" class="Wdate"
